...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>MPESO</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>MPESO</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu" style="padding-right: 15px;"  >
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo !empty($singleuser->PICLOCATION) ? web_root.'admin/user/'.$singleuser->PICLOCATION : web_root.'admin/user/photos/default.png'; ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $singleuser->FULLNAME; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header"> 
                <img data-target="#menuModal"  data-toggle="modal"  src="<?php echo !empty($singleuser->PICLOCATION) ? web_root.'admin/user/'.$singleuser->PICLOCATION : web_root.'admin/user/photos/default.png'; ?>" class="img-circle" alt="User Image" />  
              </li> 
              <!-- Menu Footer-->
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2025 <a href="m.me/kh1ddtv">Samael</a>.</strong> All rights
    reserved.
  </footer>
