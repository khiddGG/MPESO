...
function doRegister(){
	...
	if (isset($_POST['btnRegister'])) { 
			...
			$applicant->CONTACTNO = $_POST['TELNO'];
			$applicant->DEGREE = $_POST['DEGREE'];
			$applicant->APPLICANTPHOTO = ''; // Default empty if not provided
			$applicant->NATIONALID = ''; // Default empty if not provided
			...
			try {
				...
				message("An error occurred during registration. Please try again.", "error");
				redirect("index.php?q=register");
			}
		}
	}
