...
<head>
<meta charset="utf-8">
<title>MPESO / <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. +639360634339</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">MPESO<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          South Road National Highway<br>
           PQRJF+XR4, Brooke's Point, Palawan</address>
          <p>
            <i class="icon-phone"></i> +639360634339<br>
            <i class="icon-envelope-alt"></i>mamararabia03@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>Copyright &copy; 2025 <a href="https://m.me/kh1ddtv">Samael</a>.
            </p>
          </div>
        </div>
        <div class="col-lg-6">
